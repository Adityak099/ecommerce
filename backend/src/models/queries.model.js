export const getUserInfo = `SELECT username,email,phone,first_name,last_name,avatar,cover_image,created_at,updated_at, refresh_token FROM users WHERE user_id = ?;`;
